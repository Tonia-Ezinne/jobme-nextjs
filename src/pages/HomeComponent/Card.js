...
const Card = () => {
  return (
    ...
    <div className=" lg:w-5/12 md:w-6/12 shadow-xl  rounded-2xl flex items-center justify-center mx-auto  mt-5 mb-5">
      <div className="order-1 lg:order-1 mt-6 w-full p-5 ">
        <div className="mb-2">
          <h1 className="text-start font-semibold text-xl">Digital Marketer</h1>
          <div className="">
        ...
        <div className="border-t-2 mb-2">
          <div className="flex gap-3">
            <div className="mt-2">
              <Image src="/Frame 23.png" width={90} height={100} alt="frame" />
            </div>
